...
export const defaultCampaigns=[
  {id:1,name:'Festive Sale Launch',description:'Sale campaign for festive offers.',status:'Active',platform:'Instagram',audience:'18-24',budget:18000,banner:banner1,ownerName:'Rahul Sharma',ownerEmail:'rahul@test.com',createdBy:'Admin User',createdAt:'2026-07-10'},
  {id:2,name:'Search Lead Campaign',description:'Lead campaign for search traffic.',status:'Paused',platform:'Google Search',audience:'25-34',budget:12500,banner:banner2,ownerName:'Normal User',ownerEmail:'user@test.com',createdBy:'Admin User',createdAt:'2026-07-12'},
  ...
  {id:5,name:'Video Reach Plan',description:'Video reach campaign for new audience.',status:'Active',platform:'YouTube',audience:'25-34',budget:27500,banner:banner2,ownerName:'Normal User',ownerEmail:'user@test.com',createdBy:'Admin User',createdAt:'2026-07-19'},
  {id:6,name:'Brand Awareness Push',description:'Awareness campaign for brand traffic.',status:'Active',platform:'Facebook',audience:'35+',budget:23500,banner:banner1,ownerName:'Priya Nair',ownerEmail:'priya@test.com',createdBy:'Super Admin',createdAt:'2026-07-20'}
]
